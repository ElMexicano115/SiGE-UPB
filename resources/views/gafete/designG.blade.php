    ...
    <style>
        ...
        * {
        ...
        .gafete {
            ...
            height: 13.5cm;
            padding: 10px;
            /* Agregado para separar el contenido del borde */
            box-sizing: border-box;
            /* Incluye padding en el ancho y alto */
            display: flex;
        ...
        .user-info {
            flex-grow: 1;
            /* Hace que esta sección ocupe el espacio restante */
            display: flex;
            flex-direction: column;
            justify-content: space-between;
            text-align: center;
        ...
        .user-info p {
            margin: 0;
            /* Elimina el margen de los elementos h4 y p */
        }
        ...
        <tr>
            <td id="frente">
                ...
                <h3 style="font-size: 1rem; position: relative;  margin-top: 5px; margin-bottom: 5px;">
                    <center>{{ $registro->organizacion }}</center>
                </h3>
                <br>
                <img src="{{ $registro->imagen }}" alt="User" style="height: 4cm; witdh: 3.5cm;">
                <p style="margin: 0 auto;  margin-top: 5px; margin-bottom: 3px;">{{ $registro->nombre }}</p>
                <p style="margin: 0 auto; font-size: 14px; color: #ff0040;">{{ $registro->rol }}</p>
                <br>
                <br>
            ...
            <td id="atras">
                ...
                <img src="{{ $registro->qr }}" alt="" class="tamañoimg" height="200">
                <p>
                    <center>{{ $registro->folio }}
                </p>
                <br>
                <br>
                <img src="assets/Gafete/{{ $configuracion->where('Apartado', '=', 'gafeteBottom')->first()->Valor }}"
