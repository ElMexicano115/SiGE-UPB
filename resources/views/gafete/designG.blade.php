    ...
    <div class="margen mt-4 d-flex justify-content-center">
     ...
     <div class="border border-black gafete">
         ...
         <div class="text-center">
             <h3 style="font-size: 25px; position: relative;"> <center>{{ $registro->organizacion }}</center></h3> <!-- En esta seccion va la universidad-->
             <div style="width: 5cm; margin: 0 auto;" class="mx-auto d-block my-3 text-center">
                 <center><img src="{{ $registro->imagen }}" alt="" style="margin: 0 auto;" height="160"> </center> <!-- En esta seccion va la imagen del usuario-->
             </div>
             <h4 class="fw-bold" style="font-size: 20px;"> <center>{{ $registro->nombre}}</center></h4> <!-- En esta seccion va el nombre del usuario-->
             <p style="margin-bottom: 18px;"><center>{{ $registro->rol}}</center></p> <!-- En esta seccion va el rol del usuario-->
         </div>
     ...
     <div class="border border-black m-0 p-0 ms-2 gafete">
         ...
         <div class="text-center" style="margin-bottom: 40px;">
            <div style="width: 200px; margin: 0 auto" class="mx-auto d-block mt-3 mb-2"><br>
                <img src="{{ $registro->qr }}" alt="" class="tamañoimg" height="200"> <!-- En esta seccion va el qr del usuario-->
            </div>
            <p><center>{{ $registro->folio }}</p>
        </div>
